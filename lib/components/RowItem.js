...
class RowItem extends Component {
  ...
  _dropDownOrToggle = () => {
    ...
    const isReadOnlyAndHasDropDowns =
      readOnlyHeadings && item[subKey] && showDropDowns
    if (isReadOnlyAndHasDropDowns) {
  ...
  _renderSelectedIcon = () => {
    ...
    const selectedIcon = isSelected
      ...
      : unselectedIconComponent
    return selectedIcon
      ? callIfFunction(selectedIcon) || (
          <Icon
            style={{
              color: isSelected ? mergedColors.success : 'transparent',
              paddingLeft: 10
            }}
            {...icons.check}
          />
          ...
          >
            ...
            <Text
              ...
              style={[
                ...
                itemSelected && mergedStyles.selectedItemText
              ]}
            >
              {item[displayKey]}
            </Text>
